...
app.get('/products', async (req, res) => {
  ...
  try {
    ...
    let categories = await product - service.getCategories();
...
app.get('/products/:id', async (req, res) => {
  ...
  try {
    ...
    if (req.query.category) {
      products = await product - service.getPublishedproductsByCategory(req.query.category);
    }

    else {
      products = await product - service.getPublishedproducts();
    }
  ...
  try {
    data.post = await product - service.getPostById(req.params.id);
  } catch (err) {
    data.message = "no results";
  }
